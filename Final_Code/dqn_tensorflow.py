...
MODEL_NAME = "DQN_Xception"
IM_WIDTH = 640
IM_HEIGHT = 480
MIN_MEMORY_BUFFER_SIZE = 1000
MINIBATCH_SIZE = 16
...
class DQNAgent:
    ...
    def update_memory_buffer(self, transition):
        # transition = (current_state, action, reward, new_state, done)
        self.memory_buffer.append(transition)

    def train(self):
        if len(self.memory_buffer) < MIN_MEMORY_BUFFER_SIZE:
            return

        minibatch = random.sample(self.memory_buffer, MINIBATCH_SIZE)
